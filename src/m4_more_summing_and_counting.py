...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 1
    answer = count_cosines_from(13, 17, 0.40)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 3
    answer = count_cosines_from(1, 6, -0.29)
    ...
    # Test 6:
    expected = 3
    answer = count_cosines_from(3, 6, -0.70)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 0.730134  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(7, 13)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 2.828968  # This is APPROXIMATELY the correct answer.
