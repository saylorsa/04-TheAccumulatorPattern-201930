...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected = 1.19704  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(-7, -3)
    ...
    # Test 3:
    expected = -1.71573  # This is APPROXIMATELY the correct answer.
...
def run_test_count_sines_from():
    ...
    # Test 5:
    expected = 7
    answer = count_sines_from(47, 55)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 10
    answer = count_sines_from(94, 109)
